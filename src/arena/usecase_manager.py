class UsecaseManager:
    ...
    def get_usecase_descr_samenvatten(self):
    ...
    def get_usecase_descr_vereenvoudigen(self):
    ...
    def get_samenvatten_prompt(self):
        # Return samenvatten prompt
    ...
    def get_vereenvoudigen_prompt(self):
        # Return vereenvoudigen prompt 
